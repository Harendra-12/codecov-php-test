...
import TripForm from "./TripForm-c";
...
import { hiddenNumber, visibleNumber } from "../GlobalData/GlobalMetaData";
                      ...
                      >
                        ...
                        >
                          {`${findDayOfWeek(dates[0])}, ${findMonthOfWeek(
                            dates[0]
                          )} ${findDay(dates[0])} ${(new Date(dates[0])).getFullYear()}`}
                          <br />
                      ...
                      >
                        ...
                        >
                          {`${findDayOfWeek(dates[1])}, ${findMonthOfWeek(
                            dates[1]
                          )} ${findDay(dates[1])} ${(new Date(dates[1])).getFullYear()}`}{" "}
                          <br />
                      ...
                      >
                        ...
                        >
                          {`${findDayOfWeek(dates[2])}, ${findMonthOfWeek(
                            dates[2]
                          )} ${findDay(dates[2])} ${(new Date(dates[2])).getFullYear()}`}
                          <br />
                      ...
                      >
                        ...
                        >
                          {`${findDayOfWeek(dates[3])}, ${findMonthOfWeek(
                            dates[3]
                          )} ${findDay(dates[3])} ${(new Date(dates[3])).getFullYear()}`}
                          <br />
                      ...
                      >
                        ...
                        >
                          {`${findDayOfWeek(dates[4])}, ${findMonthOfWeek(
                            dates[4]
                          )} ${findDay(dates[4])} ${(new Date(dates[4])).getFullYear()}`}
                                    ...
                                    SAW
                                      ...
                                      <div className="col-2 my-auto mx-1">
                                        ...
                                        <div className="text-white-1 font-size-12 text-nowrap text-center fw-semibold">
                                          ...
                                          )} ${(new Date(item.itineraries[0]["segments"][
                                            item.itineraries[0]["segments"]
                                              .length - 1
                                          ].arrival["arrivalAt"].slice(0, 10))).getFullYear()}`}
                                        </div>
                                      </div>
                                    </div>
                                  </div>
                                        ...
                                        <div className="row text-center gx-0">
                                          <div className="col-2 my-auto">
                                            ...
                                            <div className="text-white-1 font-size-12 text-nowrap text-center">
                                              ...
                                              )} ${(new Date( item.itineraries[1][
                                                "segments"
                                              ][0].departure[
                                                "departureAt"
                                              ].slice(0, 10))).getFullYear()}`}
                                            </div>
                                          </div>
                                          <div className="col-7 text-center">
                                            <div>
                                    ...
                                    SAW
                                          ...
                                          <div className="col-2 my-auto mx-1">
                                            ...
                                            <div className="text-white-1 font-size-12 text-nowrap text-center">
                                              ...
                                              )} ${(new Date( item.itineraries[1]["segments"][
                                                item.itineraries[1][
                                                  "segments"
                                                ].length - 1
                                              ].arrival["arrivalAt"].slice(
