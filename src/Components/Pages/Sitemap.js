    ...
    <section className="sitemap section_margin">
      <div className="container">
        <div className="row">
          ...
          {/* END COL */}
          <div
            className="col-md-12 col-12 col-lg-12 mt-5 d-flex"
            data-aos="right"
          >
          ...
          <div className="row mt-2">
            ...
            <div className="col-lg-3 col-md-4 col-6">
              <Link onClick={goToTop} to="/about-us">
                About Us
              </Link>
            </div>
            {/* <div className="col-lg-3 col-md-4 col-6">
          <Link onClick={goToTop} to="/flights">Flights</Link>
            ...
            <div className="col-lg-3 col-md-4 col-6">
              <Link onClick={goToTop} to="/refund-policy">
                Refund Policy
              </Link>
            </div>
            <div className="col-lg-3 col-md-4 col-6">
              <Link onClick={goToTop} to="/privacy-policy">
                Privacy Policy
              </Link>
            </div>
            <div className="col-lg-3 col-md-4 col-6">
              <Link onClick={goToTop} to="/terms-conditions">
                Terms &amp; Conditions
              </Link>
            </div>
            <div className="col-lg-3 col-md-4 col-6">
              <Link onClick={goToTop} to="/business-class">
                Business Class
              </Link>
            </div>
            <div className="col-lg-3 col-md-4 col-6">
              <Link onClick={goToTop} to="/first-class">
                First Class
              </Link>
            </div>
            <div className="col-lg-3 col-md-4 col-6">
