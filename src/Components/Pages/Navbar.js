        ...
        <div className="container">
          <div className="row">
            ...
            <div className="col-lg-8 col-md-8 col-sm-8">
              <ul className="menu my-1 justify-content-center" id="#">
                <li
                  onClick={handleClick}
                ...
                >
                 ...
                 <li
                  onClick={handleClick}
                  className={counter === "/all-services" ? "active" : ""}
                >
                  <Link
            ...
            <div className="col-lg-2 d-none d-xl-flex align-items-center justify-content-center">
              <div className="my-auto">
                <a href={hiddenNumber} className="callBtn">
                  Call Now
                </a>
              </div>
            </div>
