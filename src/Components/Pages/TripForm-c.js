  ...
  return (
    <>
      <form
        // action="#"
        // method="POST"
        className="travel-search-form abc"
        ...
        <div className="row">
          ...
          <div className="col-xl-3 col-lg-6 mt-md-4 mt-xl-4 mt-4">
            <div className="form-group form-style">
              <i class="fa-light fa-plane-departure flight_icon11"></i>
              <input
                type="text"
          ...
          <div className="col-xl-3 col-lg-6 mt-md-3 mt-3 mt-xl-4">
            <div className="form-group destination-placeholder form-style">
              <i class="fa-light fa-plane-arrival flight_icon11"></i>
              <input
                type="text"
          ...
          >
            <div className="form-group form-style">
              <i class="fa-light fa-calendar-week flight_icon11"></i>
              ...
              >
                ...
                <div className="travelerselectbox text-center p-0 m-0 d-flex justify-content-around">
                  <div className="passenger_box">
                    <i class="fa-light fa-users fs-4"></i>
                  </div>
                  <p
