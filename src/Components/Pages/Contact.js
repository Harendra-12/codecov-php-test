            ...
            <div className="row">
              <div className="col-lg-12 col-12 col-md-12 col-xl-12 text-center">
                <div className="front_page_text" data-aos="fade-up">
                  ...
                  Connect to Travel in Comfort and Delight
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="container mb-5">
            <div className="row">
              <div className="col-lg-4 col-12 col-md-6">
                ...
                Ping Us Here<span className="text-primary">!</span>
                </p>
                <div className="row">
                  <div className="col-lg-12 mt-2">
                    <div className="row connect_content rounded-0">
                      <div className="connect_img col-2">
                  ...
                  <div className="col-lg-12">
                    <div className="row connect_content">
                      ...
                      <div className="connect_text col-auto">
                        <h5>Email Address</h5>
                        <p>
                          <a href={hiddenEmail} className="text-black">
                            {email}
                          </a>
                        </p>
                      </div>
              ...
              <div className="col-lg-4 col-12 col-md-6 mt-lg-0 mt-5 contact_form">
                <p className="h4 text-center">
                Fly, by choosing the best travel partner<span className="text-primary">!</span>
                </p>
                <div className="form" style={{ margin: "16px 0px 20px 0px" }}>
                  ...
                  <div>
                    <div className="container">
                      <div className="form-group row">
                        <div className="col-6 col-xl-6 mt-3 ps-0 position-relative">
              ...
              <div className="col-lg-4 col-12 col-md-6 mx-auto mt-lg-0 mt-5">
                <p className="h4 text-center">
                  FAQ<span className="text-primary">!</span>
                </p>
                <div className="row">
                  <div className="col-lg-12">
                    <ul className="faq_collapse mt-2">
                      <li className="pb-2">
                        <a
                          href="#drop1"
                          className=""
                          ...
                          aria-controls="drop1"
                        >
                         How can I book a flight on your platform?{" "}
                          <i className="icofont-caret-down" />
                        </a>
                        <div className="collapse" id="drop1">
                          <div className="card card-body">
                            <p className="faq_text">
                            Booking a flight is easy! Simply visit our website, enter your departure and destination cities, select your travel dates, and click on the Search button. Browse through the available options, choose your preferred flight, and follow the prompts to complete the booking process.
                            </p>
                          </div>
                        </div>
                      </li>
                      <li className="py-2">
                        ...
                        <div className="collapse" id="drop2">
                          <div className="card card-body">
                            <p className="faq_text">
                            We accept a variety of payment methods to make your booking experience convenient. You can pay using major credit cards, debit cards, and other secure payment options available on our platform. Rest assured, all transactions are encrypted to ensure the safety and security of your payment information.
                            </p>
                          </div>
                        </div>
                      </li>
                      <li className="py-2">
                        <a
                          ...
                          aria-controls="drop3"
                        >
                          Can I make changes to my booked flight, and what is the cancellation policy?{" "}
                          <i className="icofont-caret-down" />
                        </a>
                        <div className="collapse" id="drop3">
                          <div className="card card-body">
                            <p className="faq_text">
                            Yes, you can make changes to your booked flight depending on the fare type selected. For information on change fees and policies, please refer to the terms and conditions during the booking process. Please do call us at our helpline number for more insights.
                            </p>
                          </div>
                        </div>
                      </li>
