...
import PreBooking from "./Components/Pages/PreBooking";
import SearchFlightLookUp from "./Components/Pages/SearchFlightLookUp";
  ...
  return (
    <>
      ...
      <Route path="/alaska-airline" element={<AlaskaAir/>} /> */}
            ...
            <Route path="/booking-details/:leadId" element={<PreBooking />} />
            <Route path="/search-flight-lookup" element={<SearchFlightLookUp />} />
